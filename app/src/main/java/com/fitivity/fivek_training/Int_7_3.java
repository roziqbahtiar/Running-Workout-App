...
public class Int_7_3 extends FifteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_THIRTEEN_GOAL_PACE = 6.75;
        PART_FOURTEEN_GOAL_PACE = 15.0;
        PART_FIFTEEN_GOAL_PACE  = 6.25;
        ...
        PART_THIRTEEN_SECONDARY_TITLE = "6:45 min/mile";
        PART_FOURTEEN_SECONDARY_TITLE = "15:00 min/mile";
        PART_FIFTEEN_SECONDARY_TITLE  = "6:15 min/mile";
