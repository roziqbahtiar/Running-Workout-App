...
import com.example.stropheum.speedcalculatortest.ThirteenPartActivity;


public class Adv_8_7 extends ThirteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_FOUR_DURATION     = 12 * 1000 * 60;
        PART_FIVE_DURATION     = 5 * 1000 * 60;
        PART_SIX_DURATION      = 12 * 1000 * 60;
