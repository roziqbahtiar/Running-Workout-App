...
public class Adv_7_7 extends FourteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_FIVE_DURATION     = 25 * 100 * 60;
        PART_SIX_DURATION      = 6 * 1000 * 60;
        PART_SEVEN_DURATION    = 25 * 100 * 60;
        PART_EIGHT_DURATION    = 6 * 1000 * 60;
        PART_NINE_DURATION     = 25 * 100 * 60;
        PART_TEN_DURATION      = 6 * 1000 * 60;
        PART_ELEVEN_DURATION   = 25 * 100 * 60;
        ...
        PART_FOURTEEN_SECONDARY_TITLE = "5:15 min/mile";
