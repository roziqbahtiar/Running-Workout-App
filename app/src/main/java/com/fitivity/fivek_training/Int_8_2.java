...
public class Int_8_2 extends FifteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_THIRTEEN_DURATION = 10 * 1000 * 60;
        ...
        PART_FOURTEEN_GOAL_PACE = 6.5;
        PART_FIFTEEN_GOAL_PACE  = 15.00;
        ...
        PART_FOURTEEN_SECONDARY_TITLE = "6:30 min/mile";
