...
import com.example.stropheum.speedcalculatortest.TenPartActivity;


public class Adv_3_7 extends TenPartActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        PART_ONE_DURATION   = 125 * 10 * 60;
        PART_TWO_DURATION   = 3 * 1000 * 60;
        PART_THREE_DURATION = 125 * 10 * 60;
        PART_FOUR_DURATION  = 3 * 1000 * 60;
        PART_FIVE_DURATION  = 125 * 10 * 60;
        PART_SIX_DURATION   = 3 * 1000 * 60;
        PART_SEVEN_DURATION = 125 * 10 * 60;
        PART_EIGHT_DURATION = 3 * 1000 * 60;
        PART_NINE_DURATION  = 8 * 1000 * 60;
