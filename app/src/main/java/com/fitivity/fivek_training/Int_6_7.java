...
public class Int_6_7 extends FifteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_ELEVEN_DURATION   = 15 * 100 * 60;
        PART_TWELVE_DURATION   = 2 * 1000 * 60;
        ...
        PART_FOURTEEN_SECONDARY_TITLE = "6:45 min/mile";
