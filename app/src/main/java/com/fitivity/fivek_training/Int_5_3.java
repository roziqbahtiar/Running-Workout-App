...
public class Int_5_3 extends FifteenPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_FIFTEEN_DURATION  = 10 * 1000 * 60;
        ...
        PART_ELEVEN_GOAL_PACE   = 6.75;
        PART_TWELVE_GOAL_PACE   = 15.0;
        PART_THIRTEEN_GOAL_PACE = 5.0;
        PART_FOURTEEN_GOAL_PACE = 20.0;
        PART_FIFTEEN_GOAL_PACE  = 10.0;
        ...
        PART_ELEVEN_SECONDARY_TITLE   = "6:45 min/mile";
        PART_TWELVE_SECONDARY_TITLE   = "15:00 min/mile";
        PART_THIRTEEN_SECONDARY_TITLE = "5:00 min/mile";
        PART_FOURTEEN_SECONDARY_TITLE = "20:00 min/mile";
        PART_FIFTEEN_SECONDARY_TITLE  = "10:00 min/mile";
