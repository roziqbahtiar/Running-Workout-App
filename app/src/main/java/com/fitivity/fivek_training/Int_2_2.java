...
import com.example.stropheum.speedcalculatortest.NinePartActivity;
import com.example.stropheum.speedcalculatortest.R;


public class Int_2_2 extends NinePartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_SEVEN_GOAL_PACE = 8.0;
        PART_EIGHT_GOAL_PACE = 7.0;
        ...
        PART_SEVEN_SECONDARY_TITLE = "8:00 min/mile";
        PART_EIGHT_SECONDARY_TITLE = "7:00 min/mile";
