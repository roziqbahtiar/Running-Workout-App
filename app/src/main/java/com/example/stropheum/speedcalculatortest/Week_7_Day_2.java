...
public class Week_7_Day_2 extends ActionBarActivity {
    ...
    final double PART_SIX_GOAL_PACE   = 11.0;
    final double PART_SEVEN_GOAL_PACE = 18.0;
    ...
    final int PART_FOUR_DURATION  = 600 * 1000;
    final int PART_FIVE_DURATION  = 600 * 1000;
    final int PART_SIX_DURATION   = 600 * 1000;
    final int PART_SEVEN_DURATION = 600 * 1000;
...
//    final String PART_SEVEN_MAIN_TITLE = "Part 7: Run 1 minute";
    ...
    final String PART_THREE_SECONDARY_TITLE = "10:00 min/mile";
    final String PART_FOUR_SECONDARY_TITLE  = "11:00 min/mile";
    final String PART_FIVE_SECONDARY_TITLE  = "10:00 min/mile";
    final String PART_SIX_SECONDARY_TITLE   = "11:00 min/mile";
    final String PART_SEVEN_SECONDARY_TITLE = "18:00 min/mile";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week_7_day_2);
...
//        nextTitle.setText(PART_ONE_NEXT_TITLE);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == 16908332) {
            stopService(new Intent(Week_7_Day_2.this, SpeedCalculationService.class));
            stopService(i);
