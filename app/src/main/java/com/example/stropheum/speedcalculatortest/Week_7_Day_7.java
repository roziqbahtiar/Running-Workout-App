...
public class Week_7_Day_7 extends SixPartActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        PART_TWO_DURATION   = 1200 * 1000;
        PART_THREE_DURATION = 600  * 1000;
        PART_FOUR_DURATION  = 1200 * 1000;
        PART_FIVE_DURATION  = 1200 * 1000;
        ...
        PART_THREE_SECONDARY_TITLE = "13:00 min/mile";
