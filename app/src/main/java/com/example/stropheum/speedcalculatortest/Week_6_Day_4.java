...
public class Week_6_Day_4 extends ActionBarActivity {
    ...
    final double PART_ONE_GOAL_PACE = 7.5;
    final double PART_TWO_GOAL_PACE = 18.0;
    final double PART_THREE_GOAL_PACE = 7.5;
    final double PART_FOUR_GOAL_PACE = 13.0;
    ...
    final int PART_TWO_DURATION = 360 * 1000;
    final int PART_THREE_DURATION = 900 * 1000;
    final int PART_FOUR_DURATION = 300 * 1000;
...
//    final String PART_SEVEN_MAIN_TITLE = "Part 7: Run 1 minute";
    ...
    final String PART_ONE_SECONDARY_TITLE = "7:30 min/mile";
    final String PART_TWO_SECONDARY_TITLE = "18:00 min/mile";
    final String PART_THREE_SECONDARY_TITLE = "7:30 min/mile";
    final String PART_FOUR_SECONDARY_TITLE = "13:00 min/mile";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_week_6_day_4);
...
//        nextTitle.setText(PART_ONE_NEXT_TITLE);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_week_6_day_4, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == 16908332) {
            stopService(new Intent(Week_6_Day_4.this, SpeedCalculationService.class));
            stopService(i);
