...
public class Week_6_Day_4 extends ActionBarActivity {
    ...
    final double PART_ONE_GOAL_PACE = 9.5;
    final double PART_TWO_GOAL_PACE = 18.0;
    final double PART_THREE_GOAL_PACE = 9.5;
...
//    final String PART_SEVEN_MAIN_TITLE = "Part 7: Run 1 minute";
    ...
    final String PART_ONE_SECONDARY_TITLE = "9:30 min/mile";
    final String PART_TWO_SECONDARY_TITLE = "18:00 min/mile";
    final String PART_THREE_SECONDARY_TITLE = "9:30 min/mile";
